...
function cssBase() {
  return `
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
    body { width: 297mm; height: 210mm; font-family: 'Montserrat', sans-serif; color: #333; overflow: hidden; }
...
function htmlTemaMaster(d) {
  return `<!DOCTYPE html><html lang="pt-BR"><head><meta charset="UTF-8"><style>${cssBase()}
    body { background: #fff; }
  ...
  <div class="c-side">
    ...
    <div class="content">
      ...
      <p class="desc">Obtendo média <span class="bold">${d.media}</span> com <span class="bold">${d.aulas_aprovadas}/${d.total_aulas}</span> aulas aprovadas no simulador clínico SENA.</p>
